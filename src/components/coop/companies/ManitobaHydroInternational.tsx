...
const item = {
    ...
    displayName: "Manitoba Hydro International",
    email: "",
    description:
        "Manitoba Hydro International provides innovative services and solutions to customers in the energy and telecommunications sectors around the world.",
    links: "https://www.mhi.ca/",
    members: [],
    image: "img/coop/mhi.png"
};
