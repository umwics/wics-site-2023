...
const item = {
    ...
    displayName: "Wawanesa Insurance",
    email: "",
    description:
        "Wawanesa Insurance provides insurance for homes, businesses, automobiles and more.",
    links: "https://www.wawanesa.com/canada/index.html",
    members: [
        {
            name: "Shenyun Wang",
            term: "Work Term 1: Winter 2018",
            tools: "Java, JSP",
            image: "img/coop/members/shenyun.jpg"
        },
        {
            name: "Tife Akinola",
            term: "Work Term 1: Winter 2018",
            tools: "XSLT Stylsheet, XML, AL3",
            image: "img/coop/members/tife.jpg"
        }
    ],
    image: "img/coop/wawanesa.png"
};
