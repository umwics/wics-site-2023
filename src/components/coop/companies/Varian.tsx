...
const item = {
    ...
    email: "",
    description:
        "Varian develops and manufactures products and solutions that innovate, support and streamline cancer-fighting solutions worldwide.",
    links: "https://www.varian.com/",
    members: [],
    image: "img/coop/varian.png"
};
