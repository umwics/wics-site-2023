...
const item = {
    id: "1",
    name: "Amazon",
    displayName: "24-7 Intouch",
    email: "",
    description: "Amazon is an eCommerce and cloud computing company.",
    links: "https://www.amazon.jobs/en/business_categories/university-recruiting",
    members: [
        {
            name: "Tiffany Jiang",
            term: "Work Term 3: Summer 2018",
            tools: "C#, XAML, Selenium, JavaScript",
            image: "img/coop/members/tiffany.jpg"
        }
    ],
    image: "img/coop/amazon.png"
};
